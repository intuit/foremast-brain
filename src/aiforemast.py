...
def main():
    ...
    wavefrontEndpoint = os.environ.get('WAVEFRONT_ENDPOINT', "https://intuit.wavefront.com")
    wavefrontToken = os.environ.get('WAVEFRONT_TOKEN', "06258b32-5ada-4485-8e78-886faf7a938b")
